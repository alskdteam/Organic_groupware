...
public class EdocFormCtDTO {
    ...
    public EdocFormCtDTO(int edoc_form_ct_no, int edoc_form_no, String employee_name, int user_id, String edoc_status, Date start_date, Date end_date, String employee_di, String employee_de, String reason_return, Date drafting_date, String title, String content, String purpose) {
