...
import com.ohgiraffers.semi_project.config.handler.AuthFailHandler;
...
//    }
    ...
    public SecurityFilterChain configure(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests( auth -> {
            ...
            login.loginPage("/login/login"); // 로그인 페이지에 해당되는 서블릿이 존재해야 한다.
            ...
            login.defaultSuccessUrl("/login/main", true); // 로그인 성공 시 이동할 페이지(서블릿이 존재해야 한다.)
