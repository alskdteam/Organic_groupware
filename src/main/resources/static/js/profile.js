...
//
//     function loadMemosForUser(userIdInput) {
//         memos = JSON.parse(localStorage.getItem(`memos_${userIdInput}`)) || [];
...
//         currentMemoIndex = null;
//         memoContent.value = '';
//         localStorage.setItem(`memos_${userIdInput}`, JSON.stringify(memos));
//         renderMemoList();
//     }
//
